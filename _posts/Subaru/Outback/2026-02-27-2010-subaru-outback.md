...
**[Recall 18V626000: Parking Brake](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** The electronic parking brake (EPB) may not engage as intended, allowing the vehicle to rollaway if the transmission is not in the proper gear when parked. A vehicle rollaway can increase the risk of a crash.
- **What to do:** Subaru will notify owners, and dealers will replace the EPB actuator assembly, free of charge. Verify completion by VIN before purchase.

**[Recall 19V007000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** In the event of a crash necessitating deployment of the passenger frontal air bag, these inflators may explode due to propellant degradation occurring after long-term exposure to absolute humidity and temperature cycling. An explosion of an inflator within the passenger frontal air bag module may result in sharp metal fragments striking the front seat.
- **What to do:** Subaru has notified owners, and dealers will replace the front passenger air bag inflator, free of charge. Verify completion by VIN before purchase.

**[Recall 19V009000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** In the event of a crash necessitating deployment of the passenger frontal air bag, these inflators may explode due to propellant degradation occurring after long-term exposure to absolute humidity and temperature cycling. An explosion of an inflator within the passenger frontal air bag module may result in sharp metal fragments striking the front seat.
- **What to do:** Subaru is notifying owners, and dealers will replace the front passenger air bag inflator, free of charge. Verify completion by VIN before purchase.

**[Recall 19V008000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** In the event of a crash necessitating deployment of the passenger frontal air bag, these inflators may explode due to propellant degradation occurring after long-term exposure to absolute humidity and temperature cycling. An explosion of an inflator within the passenger frontal air bag module may result in sharp metal fragments striking the front seat.
- **What to do:** Subaru is notifying owners, and dealers will replace the front passenger air bag inflator, free of charge. Verify completion by VIN before purchase.

**[Recall 20V001000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
...
- **What to do:** Dealers will replace the passenger air bag inflators with alternate inflators, free of charge. Verify completion by VIN before purchase.

**[Recall 20V003000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** An inflator explosion may result in sharp metal fragments striking the driver or other occupants resulting in serious injury or death.
- **What to do:** Dealers will replace the passenger air bag inflators, free of charge. Verify completion by VIN before purchase.

**[Recall 20V002000: Air Bags:Frontal:Passenger Side:Inflator Module](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** An inflator explosion may result in sharp metal fragments striking the driver or other occupants resulting in serious injury or death.
- **What to do:** Dealers will replace the passenger air bag inflators, free of charge. Verify completion by VIN before purchase.

**[Recall 19V297000: Electrical System:Ignition:Switch](https://api.nhtsa.gov/recalls/recallsByVehicle?make=Subaru&model=Outback&modelYear=2010)**
- **Issue:** If this occurs, the weight on the key ring and certain road conditions could cause the ignition switch to move out of the run position to the accessory position, turning off the engine. The engine turning off unexpectedly can increase the risk of a crash.
- **What to do:** Subaru will notify owners, and dealers will inspect the ignition switch, replacing the ignition switch, if necessary, free of charge. Verify completion by VIN before purchase.
