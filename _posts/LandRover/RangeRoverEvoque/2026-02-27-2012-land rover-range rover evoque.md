...
### Overview
The 2012 Land Rover Range Rover Evoque, while celebrated for its distinctive styling and off-road prowess, presents a mixed reliability picture. As a first-generation model, it carries some of the typical challenges associated with new platforms and complex systems. Owners have reported a range of issues, particularly concerning the powertrain and electronics, which can lead to unexpected repair costs. However, many of these issues are not universal, and regular maintenance can mitigate some potential problems. The Evoque's luxury positioning means that repairs, when needed, can be more expensive than for mainstream vehicles. Prospective buyers should be aware of these potential pitfalls and factor in the possibility of maintenance beyond routine servicing.
...
- **Symptoms:** Rough gear changes, hesitation during acceleration, transmission warning lights.
- **Solution:** Software update, transmission fluid flush and replacement, or internal transmission repair/rebuild.
- **Cost:** $500 - $3,500
...
- **Solution:** Diagnosis to find parasitic draw (e.g., faulty module, light) and repair or replacement.
- **Cost:** $200 - $800
