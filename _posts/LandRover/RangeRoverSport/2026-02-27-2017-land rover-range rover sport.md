...
- **Symptoms:** Burning oil smell, visible oil on the engine, blue smoke from exhaust.
...
### 3.0L SDV6 Diesel
**DPF Issues**
- **Symptoms:** Reduced engine power, increased fuel consumption, warning lights on the dashboard (DPF or engine warning).
...
**Hesitation/Jerking**
- **Symptoms:** Slight delay when shifting into gear, occasional jerky shifts, particularly at low speeds.
- **Solution:** Software update for transmission control module, or transmission fluid and filter service.
- **Cost:** $250 - $600
...
**Compressor Failure**
- **Symptoms:** Vehicle not raising, compressor making unusual noises or not operating, suspension fault warning.
...
**Moisture Buildup**
- **Symptoms:** Visible condensation inside headlight assemblies.
- **Solution:** Replacement of headlight seals or entire assembly if severe.
- **Cost:** $300 - $1000
...
### Headliner Sagging
**Adhesive Failure**
- **Symptoms:** Headliner material detaches from the backing, sagging in the roof area.
